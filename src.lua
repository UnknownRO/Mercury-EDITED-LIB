...
function Library:create(options)
	...
	creditsTab:credit{Name = "CheluAkaGrasu", Description = "Script Developer", Discord = "CheluAkaGrasu#0001", V3rmillion = "chelugrasu"}
	creditsTab:credit{Name = "Discord", Description = "Our Discord Link", Discord = "https://discord.gg/fKHpdaYMMm"}
